    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/veterinario/me", "/api/veterinario/me/contrasena").hasRole("VETERINARIO")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/citas").hasAnyRole("VETERINARIO", "ADMINISTRADOR")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/tipos-servicio/**").hasAnyRole("VETERINARIO", "ADMINISTRADOR")
